...
function assetUrl(path) {
  if (!path) return assetUrl('placeholders/stavrogin.jpg')
...
const PLACEHOLDER_IMAGE = assetUrl('placeholders/stavrogin.jpg')

function characterImage(character) {
  if (character && character.image) {
    return assetUrl(character.image)
  }
  return PLACEHOLDER_IMAGE || LOCAL_PLACEHOLDER
}
